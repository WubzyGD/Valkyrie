...
module.exports = async (message, msg, args, cmd, prefix, mention, client) => {
    ...
    if (tu.commands > 50 && !tu.msg) {
        await message.author.send({embeds: [new Discord.MessageEmbed()
            ...
            .addField("What next?", "If you're enjoying what I do, you can [join my support server](https://discord.gg/u9c2uD24wB) to leave feedback and say hi to my developers. You can also consider [giving the repository a star](https://github.com/ValkyrieDev/Valkyrie) to show your support! I look forward to my time with you in the future <:hearty:812130944319750144>")
