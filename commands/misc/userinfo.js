...
module.exports = {
    ...
    async execute(message, msg, args, cmd, prefix, mention, client) {
        ...
        if (tu) {
            infoembed.addField('Valkyrie Commands Executed', `${tu.commands}`);
            ...
            if (tu.staff) {infoembed.addField('Valkyrie Staff Level', tu.developer ? 'Developer' : tu.admin ? 'Admin; Audit access to the bot' : tu.staff ? 'Staff; Support but with maintenance permissions' : tu.support ? 'Support; Answers tickets and help queries' : 'Member; Does not have a staff rank.', true);}
        }
