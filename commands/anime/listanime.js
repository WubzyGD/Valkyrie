...
module.exports = {
    ...
    meta: {
        category: 'Anime',
        description: "View a list of every anime Valkyrie has in her database at the moment",
        syntax: '`listanime [query]`',
        extra: null
    },
    help: new Discord.MessageEmbed()
        .setTitle("Help -> Anime Listing")
        .setDescription("See a list of every Valkyrie anime, or add a search query.")
