...
module.exports = {
    ...
    help: new Discord.MessageEmbed()
        ...
        .setDescription("Add a nickname to a character with this command. You will need to specify the name of the character first, then send the message, and after that, Valkyrie will ask you for the nickname to add.")
        .addField("Notice", "This nickname will be submitted unless you are a member of Valkyrie staff.")
