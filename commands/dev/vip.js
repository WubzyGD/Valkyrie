...
module.exports = {
    ...
    async execute(message, msg, args, cmd, prefix, mention, client) {
        ...
        if (['add', 'a', 'make', 'm'].includes(args[0])) {
            ...
            tguild.vip = true;
            tguild.save();
            client.guilds.cache.get('679127746592636949').channels.cache.get('940432676802953216').send({embeds: [logemb("Added")]});
            ...
            if (tguild) {
                ...
                client.guilds.cache.get('679127746592636949').channels.cache.get('940432676802953216').send({embeds: [logemb("Removed")]});
