...
module.exports = {
    ...
    execute(message, msg, args, cmd, prefix, mention, client, ars) {
        ...
        if ((msg.includes("want") && msg.includes("to fuck") && msg.inclues("valk")) || (msg.includes("mommy valk")) || (msg.includes("dominate valk")) || (msg.includes("dom") && msg.includes("by valk") || (msg.includes("dom me valk"))) && (message.author.id == "497598953206841375" || message.author.id == "417877804672352256" || message.author.id == "468903364533420074" || message.author.id == "335792072638595083" || message.author.id == "378014504211972106" || message.author.id == "386604180963459102" || message.author.id == "330547934951112705" || message.author.id == "599873116914581504" || message.author.id == "378773868896059394")) {
