...
module.exports = {
    ...
    async execute(message, msg, args, cmd, prefix, mention, client) {
		...
		.setDescription("Anything not \"fun\" or RPG...")
		.addField("__Calc__", ".")
		.addField("__Randnum__", ".")
		.addField("__Theme__", ".")
		.addField("__Role__", ".")
		.addField("__Avatar__", ".")
		.addField("__Coinflip__", ".")
