        ...
        if (args[0] == "edit") {
            ...
            if (args[0] == "adminedit") {
                ...
                if (args[0] == "none") {
                    ...
                    currentServer.welcome_message_channel = args[0]; getChannel(); if (currentServer.welcome_message_channel == 0) {return message.reply("You must tag a channel or provide an ID!");}; save();
