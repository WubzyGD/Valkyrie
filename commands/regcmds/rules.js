...
module.exports = {
    ...
    execute(message, msg, args, cmd, prefix, mention, client) {
        ...
        if (args[0] == "view") {
            ...
            if (!message.member.permissions.has("ADMINISTRATOR")) {return message.reply("You must be an administrator to do that! Try suggesting a rule addition to an admin!");}
