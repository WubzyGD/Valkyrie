    ...
    return new SlashCommand('8ball', client,
        ...
        async (client, interaction) => {
            const responses = [
                ...
                /*Neutral Responses */ ,"Maybe", "I'm not sure", "I'll think about it", "Uhh Valkyrie isn't here right now. I can take a message?", "I'm sure if you look deep within your heart, which is currently all over that tree, you'll find the answer", "I mean, if you think so...", "I don't have an opinion on that.", "I'll choose to remain silent."
            ];
            return await interaction.reply({embeds: [new Discord.MessageEmbed()
                ...
                .setColor("dc134c")
                .setFooter({text: `Asked by ${interaction.guild ? interaction.member.displayName : interaction.user.username} | Valkyrie`})
                .setTimestamp()
