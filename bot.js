...
client.on("message", async message => {
	...
	console.log((new Date().getTime() - new Date(last_treasureRoll).getTime()) / 1000, last_treasureRoll.getDate(), last_treasureRoll);
	if (((new Date().getTime() - new Date(last_treasureRoll).getTime()) / 1000 >= 60) && Math.floor(Math.random() * 100) <= 2) {spawnTreasure(); var last_treasureRoll = new Date();};
